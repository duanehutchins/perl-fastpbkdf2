 ...
 * contents of hello_538c.xs. Do not edit this file, edit hello_538c.xs instead.
 *
 *    ANY CHANGES MADE HERE WILL BE LOST!
 *
 */

#line 1 "hello_538c.xs"
#include "EXTERN.h"
#include "perl.h"
#include "XSUB.h"
#include "INLINE.h"
...
#line 197 "hello_538c.c"

XS_EUPXS(XS_main_get_localtime); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_main_get_localtime)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "utc");
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
	SV *	utc = ST(0)
;
#line 54 "hello_538c.xs"
        I32* temp;
#line 212 "hello_538c.c"
#line 56 "hello_538c.xs"
...
XS_EUPXS(XS_main_hello); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_main_hello)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
    ...
    SP -= items;
    {
#line 69 "hello_538c.xs"
        I32* temp;
#line 241 "hello_538c.c"
#line 71 "hello_538c.xs"
        temp = PL_markstack_ptr++;
        hello();
        if (PL_markstack_ptr != temp) {
          /* truly void, because dXSARGS not invoked */
...
extern "C"
#endif
XS_EXTERNAL(boot_hello_538c); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_hello_538c)
{
    dVAR; dXSARGS;
    ...
    XS_VERSION_BOOTCHECK;
        ...
        newXS("main::get_localtime", XS_main_get_localtime, file);
        newXS("main::hello", XS_main_hello, file);
#if (PERL_REVISION == 5 && PERL_VERSION >= 9)
  if (PL_unitcheckav)
