# This Makefile is for the Crypt::OpenSSL::FASTPBKDF2 extension to perl.
#
...
NAME_SYM = Crypt_OpenSSL_FASTPBKDF2
VERSION = 0.01
...
MAKE = make
FULLEXT = Crypt/OpenSSL/FASTPBKDF2
BASEEXT = FASTPBKDF2
...
XS_FILES = FASTPBKDF2.xs
C_FILES  = FASTPBKDF2.c
O_FILES  = FASTPBKDF2.o
H_FILES  = fastpbkdf2.h \
	ppport.h
MAN1PODS = 
MAN3PODS = lib/Crypt/OpenSSL/FASTPBKDF2.pm
...
TO_INST_PM = lib/Crypt/OpenSSL/FASTPBKDF2.pm

PM_TO_BLIB = lib/Crypt/OpenSSL/FASTPBKDF2.pm \
...
XSPROTOARG = 
XSUBPPDEPS = /usr/share/perl/5.20/ExtUtils/typemap typemap $(XSUBPP)
XSUBPPARGS = -typemap /usr/share/perl/5.20/ExtUtils/typemap -typemap typemap
XSUBPP_EXTRA_ARGS =
...
DISTNAME = Crypt-OpenSSL-FASTPBKDF2
DISTVNAME = Crypt-OpenSSL-FASTPBKDF2-0.01
...
# Crypt::OpenSSL::FASTPBKDF2 might depend on some other libraries:
...
manifypods : pure_all  \
	lib/Crypt/OpenSSL/FASTPBKDF2.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Crypt/OpenSSL/FASTPBKDF2.pm $(INST_MAN3DIR)/Crypt::OpenSSL::FASTPBKDF2.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Crypt-OpenSSL-FASTPBKDF2' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Crypt-OpenSSL-FASTPBKDF2",' >> META_new.json
...
test_static :: pure_all $(MAP_TARGET)
	PERL_DL_NONLAZY=1 PERL_USE_UNSAFE_INC=1 ./$(MAP_TARGET) "-MExtUtils::Command::MM" "-MTest::Harness" "-e" "undef *Test::Harness::Switches; test_harness($(TEST_VERBOSE), '$(INST_LIB)', '$(INST_ARCHLIB)')" $(TEST_FILES)
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Crypt/OpenSSL/FASTPBKDF2.pm blib/lib/Crypt/OpenSSL/FASTPBKDF2.pm 
